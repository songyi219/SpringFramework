...
<br>
<button type="button" onclick="location.href='answerbbs.do?seq=<%=dto.getSeq() %>'">답글</button>
...
function answerBbs( seq ) {
	location.href = "answerbbs.do?seq=" + seq;
}
...
<input type="hidden" name="id" value="<%=login.getId()%>">	<!-- login한사람의 id -->
...
$(document).ready(function(){
	$.ajax({
		...
		//	alert(JSON.stringify(list));
			...
			$.each(list, function(index, item){			// each는 foreach문과 비슷한 역할
				let str = "<tr class='table-info'>"		// class는 table 모양 부트스트랩 
						+  	"<td>작성자:" + item.id + "</td>"		
